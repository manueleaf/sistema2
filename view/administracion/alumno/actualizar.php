	    		...
	    		<div class="box-body">
	    			<form id="frmActualizarAlumno" action="?c=Alumno&a=Actualizar" method="post" enctype="multipart/form-data" role="form">
					    ...
					    <div class="form-group col-md-3">
					        ...
					        <input type="text" id="dni"name="dni" value="<?php echo $Alumno->__GET('dni'); ?>" class="form-control" placeholder=""  required disabled/>
					    </div>
					    <div class="form-group col-md-3">
					    ...
					    <div class="form-group col-md-3">
					        ...
					        <input type="text" id="edad" name="edad" value="<?php echo $Alumno->__GET('edad'); ?>" class="form-control" placeholder=""  required />
					    </div>

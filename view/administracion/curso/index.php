		...
		<div class="col-xs-12">
	  		<div class="box">
	    		<div class='box-header with-border'>
	      			...
	      			<a class="btn btn-sm btn-primary pull-right" href="?c=Curso&a=v_Registrar"> Nuevo Curso</a>
	    		</div>
                  	...
                  	<table id="TablaEntidad" class="table table-bordered table-hover dataTable no-footer" width="100%">
	                    ...
	                    <tbody>
	                    	...
	                    	<tr>
	                    		...
	                    		<td><?php echo ucwords(strtolower($curso['profesor'])); ?></td>
                            	...
                            	<td class="a_center">                            		
                            		<a href="?c=Curso&a=v_Actualizar&idCurso=<?php echo $curso['idCurso']; ?>" class="btn btn-primary btn-xs " data-toggle="tooltip" data-placement="top" title="Actualizar">
                               		...
                               		<a class="btn btn-danger btn-xs EliminarPersona" data-id="<?php echo $curso['idCurso']; ?>" data-curso="<?php echo $curso['nombre']; ?>" data-toggle="tooltip" data-placement="top" title="Eliminar">

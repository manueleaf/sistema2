    ...
    <?php if ($_SESSION['Perfil_Actual'] = 1): ?>
      ...
      <li class="treeview">
        ...
        <ul class="treeview-menu">                
          ...
          <li>
            <li><a href="index.php?c=Curso"><i class="fa fa-circle-o" aria-hidden="true"></i> Cursos</a></li>
          </li>
          <li>
            <li><a href="index.php?c=Alumno"><i class="fa fa-circle-o" aria-hidden="true"></i> Alumnos</a></li>
          </li>
          <li>
